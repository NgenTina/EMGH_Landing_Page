      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, idx) => (
            ...
            >
              <div className="text-4xl text-slate-200 font-serif absolute top-6 left-6">
                "
              </div>
              <p className="text-slate-600 mb-8 relative z-10 pt-4">
                {
                  t.testimonials[
                    testimonial.textKey as keyof typeof t.testimonials
                  ]
                }
              </p>
